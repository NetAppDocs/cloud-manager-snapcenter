...
By default, you can create a Connector in Azure from Azure Marketplace. While performing the steps to https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-launching-azure-mktp.html[create the connector from Azure Marketplace^], you should remember the following:
...
If the user consent is enabled in your Azure active directory, https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-creating-connectors-azure.html[create the Connector from Cloud Manager^].
...
. https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-creating-connectors-azure.html[Create the Connector from Cloud Manager^].
