...
For information on the networking requirements for Cloud Manager Connector, see https://docs.netapp.com/us-en/cloud-manager-connector/:reference-networking-cloud-manager.html[Networking requirements for the Connector^].
