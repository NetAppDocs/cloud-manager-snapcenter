...
* You should ensure that all the link:reference-prerequisites-azure-connector-snapcenter-service.html[prerequisites] are met.
...
. If you have link:reference-prerequisites-azure-connector-snapcenter-service.html#firewall-configuration[configured firewall], create a custom role using the link:media/SnapCenter-Deployment-Role3.json[SnapCenter-Deployment-Role3.json] file.
+
